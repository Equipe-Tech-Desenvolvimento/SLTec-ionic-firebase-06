...
const routes = [
    ...
    {
        path: 'msg/send',
        loadChildren: () => __webpack_require__.e(/*! import() | msg-send-send-module */ "msg-send-send-module").then(__webpack_require__.bind(null, /*! ./msg/send/send.module */ "oy9T")).then(m => m.SendPageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
        data: { authGuardPipe: toLogin }
    },
    {
        path: 'msg/inbox',
        loadChildren: () => __webpack_require__.e(/*! import() | msg-inbox-inbox-module */ "msg-inbox-inbox-module").then(__webpack_require__.bind(null, /*! ./msg/inbox/inbox.module */ "5ZWC")).then(m => m.InboxPageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
        data: { authGuardPipe: toLogin }
    },
    {
        path: 'msg/outbox',
        loadChildren: () => __webpack_require__.e(/*! import() | msg-outbox-outbox-module */ "msg-outbox-outbox-module").then(__webpack_require__.bind(null, /*! ./msg/outbox/outbox.module */ "hNGJ")).then(m => m.OutboxPageModule),
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuthGuard"]],
        data: { authGuardPipe: toLogin }
    },
