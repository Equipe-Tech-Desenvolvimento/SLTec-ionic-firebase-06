    ...
    function DZ0t(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProfileComponent = /*#__PURE__*/function () {
        ...
        app) {
          ...
          this.app = app; // 9.3) Textos da View
          ...
          this.storage.get('userData', {
            ...
            _this.fbStore.collection('select01', function (ref) {
              ...
              _this.selectDynamic = data; // 9.5) Preenche o campo automaticamente com dados do perfil se estiver editando
