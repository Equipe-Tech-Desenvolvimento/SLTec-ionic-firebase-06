...
module.exports = __webpack_require__(/*! J:\Projetos\Ionic\fireuser01\src\main.ts */"zUnb");
...
const routes = [
    ...
    {
        path: 'test01',
        loadChildren: () => Promise.all(/*! import() | pages-test01-test01-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-test01-test01-module")]).then(__webpack_require__.bind(null, /*! ./pages/test01/test01.module */ "okAj")).then(m => m.Test01PageModule),
    ...
    {
        path: 'user/login',
        loadChildren: () => Promise.all(/*! import() | user-login-login-module */[__webpack_require__.e("common"), __webpack_require__.e("user-login-login-module")]).then(__webpack_require__.bind(null, /*! ./user/login/login.module */ "EhU7")).then(m => m.LoginPageModule),
    ...
    {
        path: 'user/new',
        loadChildren: () => Promise.all(/*! import() | user-new-new-module */[__webpack_require__.e("common"), __webpack_require__.e("user-new-new-module")]).then(__webpack_require__.bind(null, /*! ./user/new/new.module */ "Js6N")).then(m => m.NewPageModule),
    ...
    {
        path: 'user/profile',
        loadChildren: () => Promise.all(/*! import() | user-profile-profile-module */[__webpack_require__.e("common"), __webpack_require__.e("user-profile-profile-module")]).then(__webpack_require__.bind(null, /*! ./user/profile/profile.module */ "HKqj")).then(m => m.ProfilePageModule),
